...
public class AuthorizationService {
    ...
    public String grantApplicationAccess() {
        ...
        // check response
        RestCallUtils.checkResponseCodeExpectedString(responseEntity, Arrays.asList(CREATED, OK), "authorize");
    ...
    public JSONObject getToken(String code) {
        ...
        // check response
        RestCallUtils.checkResponseCodeExpected(responseEntity, Arrays.asList(NO_CONTENT, OK), "getToken");
